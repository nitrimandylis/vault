...
Core concepts and case studies for Global Politics.
...
- **Explain** – Show causality
- **Analyze** – Examine components
- **Evaluate** – Assess with criteria
- **Discuss** – Present multiple views

## Related

- [[Global Politics SL – Overview]]
- [[TOK – Essay & Exhibition Toolkit]] — human rights + ethics overlap
